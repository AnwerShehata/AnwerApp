...
class _PlayerWidgetState extends State<PlayerWidget> {
  ...
  //عند الضغط يتم التشغيل
  get _isPlaying => _playerState == PlayerState.playing;
  // عند الضغط يتم الايقاف المؤقت
  get _isPaused => _playerState == PlayerState.paused;
  // هنا يعطيك طول الملف الصوتي يعني كم دقيقة
  get _durationText => _duration?.toString()?.split('.')?.first ?? '';
  //هنا الوقت الذي مضئ من الاغنية
        ...
        new Center(
          child:Column(
            children: <Widget>[
              ...
              SizedBox(height: 20),
              new Container(width: 300, height: 400, color: Colors.red,),
              ...
              new Row(
                ...
                children: [
                  new IconButton(
                      ...
                      iconSize: 64.0,
                      icon: new Icon(Icons.play_arrow), color: Colors.cyan),

                  new IconButton(
                      onPressed: _isPlaying ? () => _pause() : null,
                      iconSize: 65.0,
                      icon: new Icon(Icons.pause), color: Colors.cyan),

                  new IconButton(
                      onPressed: _isPlaying || _isPaused ? () => _stop() : null,
                      iconSize: 64.0,
                      icon: new Icon(Icons.stop), color: Colors.red),
                ],
              ),
